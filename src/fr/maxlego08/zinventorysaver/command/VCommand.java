package fr.maxlego08.zinventorysaver.command;
...
import fr.maxlego08.zinventorysaver.zcore.utils.commands.Arguments;
import fr.maxlego08.zinventorysaver.zcore.utils.commands.CommandType;
import fr.maxlego08.zinventorysaver.zcore.utils.commands.Tab;
...
public abstract class VCommand extends Arguments {
	...
	public CommandType prePerform(ZInventorySaverPlugin main, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(ZInventorySaverPlugin main);
	 ...
	 * @return
	 */
	public List<String> toTab(ZInventorySaverPlugin plugin, CommandSender sender2, String[] args) {
		return null;
	}
