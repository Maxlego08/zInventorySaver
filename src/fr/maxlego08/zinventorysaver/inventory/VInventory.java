package fr.maxlego08.zinventorysaver.inventory;
...
public abstract class VInventory extends ZUtils implements Cloneable {
	...
	protected int id;
	protected ZInventorySaverPlugin plugin;
	...
	protected InventoryResult preOpenInventory(ZInventorySaverPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(ZInventorySaverPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, ZInventorySaverPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, ZInventorySaverPlugin plugin, Player player) {
	}
